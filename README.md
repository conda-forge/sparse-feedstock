...
Documentation: https://sparse.pydata.org/en/0.19.2/
...
It is possible to list all of the versions of `sparse` available on your platform:
...
```
pixi search sparse --channel conda-forge
```
